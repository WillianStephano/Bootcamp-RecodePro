...
export default function Contato() {
   return (
      <section className="position-relative py-4 py-xl-5 secao_contao">
         <div className="container position-relative">
            <div className="row mb-5">
               <div className="col-md-8 col-xl-6 text-center mx-auto">
                  <h2>Contato</h2>
                  <p className="w-lg-50">Nos envie sua duvida para que um consultor entre em contato imediatamente !</p>
               </div>
            </div>
            <div className="row d-flex justify-content-center">
               <div className="col-md-6 col-lg-4 col-xl-4 icons-formulario">
                  <div className="d-flex flex-column justify-content-center align-items-start h-100">
                     <h5 className="text-center">Ou entre em contato clicando abaixo</h5>

                     <a className="link_contato" href="tel:+55(11)40028922">
                        <div className="d-flex align-items-center p-3">
                           ...
                           <div className="px-2">
                              ...
                              <p className="mb-0"> (11)4002822</p>
                           </div>
                        </div>
                     </a>

                     <a className="link_contato" href="mailto:flyWay@gmail.com">
                        <div className="d-flex align-items-center p-3">
                           <div className="bs-icon-md bs-icon-rounded bs-icon-primary d-flex flex-shrink-0 justify-content-center align-items-center d-inline-block bs-icon">
                           ...
                           <div className="px-2">
                              ...
                              <p className="mb-0"> FlyWay@gmail.com</p>
                           </div>
                        </div>
                     </a>

                     <a className="link_contato" href="https://goo.gl/maps/4rjDCR5CJE1t564r6" target="_blank">
                        <div className="d-flex align-items-center p-3">
                           <div className="bs-icon-md bs-icon-rounded bs-icon-primary d-flex flex-shrink-0 justify-content-center align-items-center d-inline-block bs-icon">
                           ...
                           <div className="px-2">
                              ...
                              <address className="mb-0">
                                 Praça da Sé, 68 - Centro Histórico de São Paulo, SP
                              </address>
                           </div>
                        </div>
                     </a>
               ...
               <div className="col-md-6 col-lg-5 col-xl-6 formulario-contato">
                  <div>
                     <form className="p-3 p-xl-4" method="post">
                        <div className="mb-3">
                           <input className="form-control" type="text" id="name-1" name="name" placeholder="Nome" />
                        </div>
                        <div className="mb-3">
                           <input className="form-control" type="email" id="email-1" name="email" placeholder="Email" />
                        </div>
                        <div className="mb-3">
                           <textarea className="form-control" id="message-1" name="message" rows="6" placeholder="Mensagem"></textarea>
                        </div>
                        <div>
